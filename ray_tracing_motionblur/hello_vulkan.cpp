...
void HelloVulkan::createBottomLevelAS()
{
  ...
  allBlas.emplace_back(objectToVkGeometryKHR(m_objModel[0]));  // cube multi
  allBlas.emplace_back(objectToVkGeometryKHR(m_objModel[1]));  // plane

  // Animated geometry
  allBlas.emplace_back(objectToVkGeometryKHR(m_objModel[2]));  // cube
  ...
  motionTriangles.vertexData.deviceAddress = nvvk::getBufferDeviceAddress(m_device, m_objModel[3].vertexBuffer.buffer);  // cube_modif
