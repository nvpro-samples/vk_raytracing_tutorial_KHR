...
struct TutoPushConstant
{
  ...
  int            useImageColoring;           // Toggle for grass image coloring
  float          colorIntensity;             // Grass color intensity
  float2         grassFieldSize;             // Size of the grass field for texture mapping
};
