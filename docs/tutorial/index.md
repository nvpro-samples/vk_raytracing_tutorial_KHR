...
| Before | After |
| ------ | ----- |
| ![Before: rasterized scene](../images/01.png) | ![After: ray traced scene](../images/02.png) |
...
- [**`02_basic`**](https://github.com/nvpro-samples/vk_raytracing_tutorial_KHR/tree/v2/raytrace_tutorial/02_basic) - Uses **direct Vulkan calls** for educational purposes, showing the complete ray tracing implementation without helper libraries
- [**`02_basic_nvvk`**](https://github.com/nvpro-samples/vk_raytracing_tutorial_KHR/tree/v2/raytrace_tutorial/02_basic_nvvk) - Uses **nvpro-core2 helper libraries** (`nvvk::AccelerationStructureHelper` and `nvvk::SBTGenerator`) for simplified development
...
4. **[Rendering Acronyms and Concepts](../concepts/rendering.md)** - Plain-language guide to BRDF, BSDF, PDF, NEE, MIS, and more
...
Before starting, make sure to do the following [setup](../getting-started/setup.md).
...
graph BT
    ...
    subgraph "Scene Objects"
        A[Teapot Mesh]:::neutral --> B[Teapot BLAS]:::lightBlue
        C[Sphere Mesh]:::neutral --> D[Sphere BLAS]:::lightBlue
        E[Cube Mesh]:::neutral   --> F[Cube BLAS]:::lightBlue
    end
...
Note: The [acceleration helpers](../concepts/acceleration-structures.md) handle all of this and more. However, to keep things simple, we are using a straightforward method here.
...
**Documentation**: It is strongly recommended to read the [acceleration structure](../concepts/acceleration-structures.md) document at this point. It explains the concepts and the helpers used here.
...
**📖Documentation**: It is strongly recommended to read the [shader binding table](../concepts/shader-binding-table.md) document at this point. It explains the concepts and implementation details.
...
- New to terms like BRDF, BSDF, PDF, NEE, or MIS? See the [plain-language rendering guide](../concepts/rendering.md).
...
Check out the [complete set of samples](../samples/index.md).

### Further Reading

For advanced ray tracing techniques:

- **[Acceleration Structures Guide](../concepts/acceleration-structures.md)** - Comprehensive guide to BLAS/TLAS construction, memory management, and optimization
- **[Shader Binding Table Guide](../concepts/shader-binding-table.md)** - Complete reference for SBT creation, alignment, and advanced usage patterns
...
- **Direct Vulkan ([`02_basic`](https://github.com/nvpro-samples/vk_raytracing_tutorial_KHR/tree/v2/raytrace_tutorial/02_basic))**: Full control, educational value, more code to maintain
- **Helper Libraries ([`02_basic_nvvk`](https://github.com/nvpro-samples/vk_raytracing_tutorial_KHR/tree/v2/raytrace_tutorial/02_basic_nvvk)+)**: Simplified development, better performance, production-ready
